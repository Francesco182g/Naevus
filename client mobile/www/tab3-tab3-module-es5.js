...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab3-tab3-module"], {
  ...
  function srcAppTab3Tab3ModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Tab3PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      ...
      }]), _tab3_routing_module__WEBPACK_IMPORTED_MODULE_8__["Tab3PageRoutingModule"], ng2_file_upload__WEBPACK_IMPORTED_MODULE_9__["FileUploadModule"]],
  ...
  function srcAppTab3Tab3PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _uploading_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../uploading.service */
    "./src/app/uploading.service.ts");
    /* harmony import */


    var _api_django_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../api-django.service */
    ...
    var Tab3Page = /*#__PURE__*/function () {
      function Tab3Page(uploadingService, http, apiDjangoService, file, ngZone, loadingController) {
      ...
      _createClass(Tab3Page, [{
        ...
        value: function uploadFiles() {
          ...
          files.forEach(function (file) {
            ...
            requests.push(_this.uploadingService.uploadFormData(formData));
            requests.push(_this.apiDjangoService.getClassified());
            _this.dark = "dark";

            _this.presentLoading();
          });
          Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["concat"]).apply(void 0, requests).subscribe(function (res) {
            console.log(res);
            _this.classificatore = " " + res + " %";
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function getAsymmetry() {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["concat"]).apply(void 0, items).subscribe(function (res) {
            console.log(res);
            _this2.asymmetry = "" + res;
          }, function (err) {
            console.log(err);
          });
        }
        ...
        value: function changePlaying() {
          ...
          this.ngZone.run(function () {
            _this3.nameOfSource = "http://192.168.1.2:8000/media/melar.jpg";
          });
        }
      }, {
        key: "presentLoading",
